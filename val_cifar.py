...
if __name__ == '__main__':
    ...
    input_image_size = EZenNet.zennet_model_zoo[opt.arch]['resolution']
    crop_image_size = EZenNet.zennet_model_zoo[opt.arch]['crop_image_size']
    ...
    # load model
    model = EZenNet.get_ZenNet(opt.arch, pretrained=True)
