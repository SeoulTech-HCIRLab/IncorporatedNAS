...
params_dict = {
    ...
    'AffectNet':{
        'train_dir': os.path.expanduser('/home/gpuadmin/juns/datasets/AffectNet/train'),
        'val_dir': os.path.expanduser('/home/gpuadmin/juns/datasets/AffectNet/valid'),
        'num_train_samples': 283901,
        'num_val_samples': 3500,
        'num_classes': 7,
    },
    'AffectNet8':{
    'train_dir': os.path.expanduser('/home/gpuadmin/juns/datasets/AffectNet8/train'),
    'val_dir': os.path.expanduser('/home/gpuadmin/juns/datasets/AffectNet8/valid'),
