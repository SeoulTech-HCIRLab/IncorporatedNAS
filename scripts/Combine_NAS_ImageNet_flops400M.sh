...
save_dir=CombineNAS/ImageNet_flops600M
mkdir -p ${save_dir}
...
epochs=480
efficient_score=0.5
evolution_max_iter=96000  # we suggest evolution_max_iter=480000 for sufficient searching
...
python evolution_search.py --gpu 3 \
  --zero_shot_score Zen \
...
python ts_train_image_classification.py --dataset imagenet --gpu 3 --num_classes 1000 \
